...
export const translations = {
  ...
  ru: {
    ...
    receiveUpdatesEmail: "Получать обновления о своих ордерах по электронной почте",
    telegramNotifications: "Уведомления в Telegram",
    receiveUpdatesTelegram: "Получать обновления о своих ордерах в Telegram",
    notificationTypes: "Типы уведомлений",
    orderUpdates: "Обновления ордеров",
    orderUpdatesDesc: "Уведомления о существующих ордерах",
    ...
    telegramSuccessConnected: "Ваш аккаунт Telegram успешно подключен к OTC Desk. Теперь вы будете получать уведомления о ваших ордерах и сделках.",
    ...
    instantAlerts: "Получайте мгновенные оповещения при соответствии ваших ордеров или обновлениях.",
    ...
    manageOrdersMobile: "Управляйте своими ордерами в пути без необходимости входа в веб-приложение.",
    
    // Create Order page
    orderDetails: "Детали ордера",
    enterOrderDetails: "Введите детали вашего OTC ордера.",
    ...
    selectWhenExpires: "Выберите, когда этот ордер истекает",
    paymentPurpose: "Назначение платежа",
    purposeExample: "Например, Оплата импорта, Экспортная выручка и т.д.",
    additionalNotes: "Дополнительные примечания",
    notesPlaceholder: "Любые дополнительные детали или требования для этого ордера",
    cancel: "Отмена",
    creatingOrder: "Создание...",
    createOrder: "Создать ордер",
    minOrderSize: "Минимальный размер ордера",
    otcMinimumReq: "OTC Desk требует минимальный размер ордера эквивалентный 500 000 USD.",
