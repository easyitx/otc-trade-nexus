        ...
        <Card className="bg-otc-card border-otc-active">
          ...
          <CardContent className="space-y-6">
            <Alert className="bg-otc-secondary/20 border-otc-icon text-white">
              ...
              <AlertDescription>
                Эти корректировки влияют на все заявки, созданные с использованием соответствующего источника курсов. Изменения будут применяться только к новым заявкам.
              </AlertDescription>
            </Alert>
